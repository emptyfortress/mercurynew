...
q-page(padding
	...
	.mainwin
		.top(@click='control.deselect')
			.zg Форма "Просмотр"
			div
				q-btn.ddis(flat round dense icon="mdi-undo" color="primary" @click="") 
				q-btn.ddis(flat round dense icon="mdi-redo" color="primary" @click="") 
				q-btn.q-ml-md.ddis(flat round dense icon="mdi-content-duplicate" color="primary" @click="") 
